...
2. **Depuis `l'email propriétaire de la fiche GBP`** — propriétaire de la fiche GBP vérifiée le 25/03/2026 (= 60 jours le 24/05)
...
- [ ] Ajouter test users : `l'email propriétaire de la fiche GBP`, `contact@fidelavis.com`, propriétaires Le Martin
